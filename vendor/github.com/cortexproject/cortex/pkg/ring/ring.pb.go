...
const (
	...
	// Ingester has left ring, but to distribute that information,
	// we actually need to send something out (when doing ring gossiping)
	// Leave time = last heartbeat timestamp.
...
type IngesterDesc struct {
	...
	State     IngesterState `protobuf:"varint,3,opt,name=state,proto3,enum=ring_model.IngesterState" json:"state,omitempty"`
...
func init() {
	proto.RegisterEnum("ring_model.IngesterState", IngesterState_name, IngesterState_value)
	proto.RegisterType((*Desc)(nil), "ring_model.Desc")
	proto.RegisterMapType((map[string]IngesterDesc)(nil), "ring_model.Desc.IngestersEntry")
	proto.RegisterType((*IngesterDesc)(nil), "ring_model.IngesterDesc")
	proto.RegisterType((*TokenDesc)(nil), "ring_model.TokenDesc")
}
...
var fileDescriptor_26381ed67e202a6e = []byte{
	...
	,
}
...
func (this *IngesterDesc) GoString() string {
	...
	s := make([]string, 0, 8)
	s = append(s, "&ring_model.IngesterDesc{")
...
func (this *TokenDesc) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&ring_model.TokenDesc{")
